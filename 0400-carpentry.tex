...
\end{itemize}
    ...
    \begin{itemize}
        ...
        \item To provide users a starting point, presenting the community with a collection of benchmarks can be useful and has been spearheaded at \citep{www-las-mlcommons-benchmark-coolection}.
    \end{itemize}
\end{description}
