...
To illustrate the issue, we have provided in Table \ref{tab:energy-chatgpt} and Figure \ref{fig:energy-consumption} the energy required to train various ChatGPT models (some of which are estimated as no public data has been released \citep{sciencefeedback2024energy,kaplan2020scaling}, such as GPT-5 and GPT-6). The training of a single large-scale language model (GPT-3) consumes approximately 1,287 MWh placing it in the same range as the annual energy usage of about 130 U.S. households, according to U.S. Energy Information Administration (EIA) statistics on average residential electricity consumption \citep{EIA_Electricity_Price_2025,eia2024residential,WECEnergy,patterson2021carbon,jegham2025hungryaibenchmarkingenergy,baeldung2023energy}. 
...
%(Based on \citep{brown2020language, patterson2021carbon, medium2023gpt4carbon, 
...
\hline
\hline
GPT-3 & $\sim$1,287 \citep{baeldung2023energy,patterson2021carbon} & $\sim$50--100 \\
\hline
GPT-4 & 51,773--62,319 \citep{medium2023gpt4carbon,extremenetworks2023energy} & $\sim$600--1,000 \\ \hline 
GPT-5 & $>$60,000 (estimated) \citep{epochai2024compute,hackernoon2024dirtysecret} & $\sim$800--1,200 \\ \hline
GPT-6 & 80,000--100,000 (projected) \citep{epochai2024compute} & $\sim$1,000--1,500 \\ \hline
\end{tabular}
%}
\end{table}
...
\begin{figure}[tb]
    \centering
    \includegraphics[width=0.6\linewidth]{images/gpt_energy_comparison.pdf}
...
\begin{table}[tb]
    ...
    \resizebox{\columnwidth}{!}{
        \begin{tabular}{|l|c|l|r|r|r|r|r|}
            ...
            \hline
            \hline
            Jaguar\citep{BlandRogers2009-jaguar}       & 2009 & Multi-core CPU  & 1 &    1941 &    2628 & 7  & 277.29 \\
            \hline
            Titan\citep{Bland2012-titan}               & 2012 & Hybrid CPU/GPU  & 9.06 &   17590 &   27113 & 9  & 1954.44  \\
            \hline
            Summit\citep{WombleShankar2019-summit}     & 2017 & Hybrid CPU/GPU  & 76.6 &  148600 &  200795 & 13  & 11430.77  \\
            \hline
            Frontier\citep{AtchleyZimmer2023-frontier} & 2022 & Hybrid CPU/GPU  & 697.1 & 1353000 & 2055717 & 29  & 46655.17  \\
            \hline
        \end{tabular}
    }
...
\(24.6\;\text{MW}\) at LINPACK load and is housed in a data hall whose measured PUE is \(1.03\)\,\citep{DOE_Frontier_Power2023}. At the July 2025 U.S.\ industrial tariff of
\$0.081 kWh\(^{-1}\)\,\citep{EIA_Electricity_Price_2025} the annual electricity bill is: $24.6\;\text{MW}\times 8\,760\;\text{h\,yr}^{-1}\times\$0.081
...
(Eurostat 2024, 6.5 t cap\(^{-1}\))\,\citep{Eurostat_GHG_2024}.

%\vspace{4pt}
\noindent
\textbf{Case 2 – Google hyperscale fleet.} %
Google’s 2023 environmental report lists a \emph{fleet-wide} PUE of
\(\mathbf{1.10}\) (industry mean 1.58)\,\citep{Google_PUE_2023} yet company-wide GHG emissions still rose to
\(14.3\;\text{Mt\,CO}_{2}\text{e}\) in 2023, up 49 \% since
2019\,\citep{Google_Sustainability_2024}.   % <5>
...
in 2026\,\citep{Google_Geothermal_2023}.   % <6>
...
We believe we have to go beyond established leaderboards such as {\em Green500} and the {\em MLPerf Power}, which already influence processor road-maps and procurement calls~\citep{Scogland11Green500,Tschand24MLPerfPower}, to raise awareness of the energy impact on real-world scientific applications.
...
\mmB & SPECpower\_ssj2008           & \citep{specpower}            & W/transaction; ops/W                & Enterprise-server rankings; ENERGY STAR compliance \\ \hline
\mmB & SPEC\,SERT$^{2}$             & \citep{sert2}                & Server-Efficiency-Rating = kWh + perf    & EU Lot 9 certification; vendor datasheets \\ \hline
\mmB & TPC-Energy                   & \citep{tpcenergy}            & Wh/DB phase                            & OLTP/warehouse energy cost studies \\ \hline
\mmB & JouleSort                    & \citep{joulesort}            & records/J                              & Storage-I/O contests; I/O-stack tuning \\ \hline
\mmB & Green500                     & \citep{green500}             & GFLOPS/W (HPL or HPL-AI)               & Global supercomputer energy ranking \\ \hline
\mmB & HPCG-Power                   & \citep{hpcgpower}            & GFLOPS/W (HPCG)                        & Memory-bound tuning; procurement add-on to TOP500 \\ \hline
\mmB & HPL-MxP (HPL-AI)             & \citep{hplmxphplai}          & mixed-precision GFLOPS/W               & GPU/TPU evaluation for AI-optimised LINPACK \\ \hline
\mmB & MLPerf Power                 & \citep{mlperfpower}          & J; avg W; J/sample; J/epoch       & Official energy track for MLPerf submissions \\ \hline
\mmB & MLPerf Tiny                  & \citep{mlperftiny}           & $\mu$J/inference (MCU)             & Edge-AI board comparison; ultra-low-power design \\ \hline
\mmB & CoreMark-PRO Power           & \citep{coremarkpro}          & iterations/s/W (SoC)                 & Pre-silicon DVFS sweeps; embedded RFPs \\ \hline 
\mmB & UL Procyon AI Power          & \citep{procyon}              & images/W; fps/W                     & Smartphone \& laptop AI-inference benchmarks \\ \hline
\mmB & CANDLE Power Study           & \citep{candlepowerstud}      & J/epoch; GFLOPS/W                   & DOE accelerator procurement guidance \\ \hline
\mmB & LULESH/miniFE Energy       & \citep{luleshminifeene}      & J/iteration                            & DVFS + autotuning baselines \\ \hline
\mmB & ExaSMR Power Benchmark       & \citep{exasmrpowerbenc}      & J/neutron; energy-vs-accuracy curve   & Energy budget strategy in nuclear simulations \\ \hline
\mmB & EE-HPC-WG Energy Benchmark   & \citep{eehpcwgenergybe}      & draft node/job spec; JSON trace       & Toward common HPC energy standard \\ \hline
\mmB & HPC-AI500 Energy Track       & \citep{hpcai500energyt}      & planned: GFLOPS/W; tokens/J         & Mixed AI/HPC cluster evaluations \\ \hline
\mmB & PARSEC-3.1 Energy Extension  & \citep{parsec31energye}      & W; J via PAPI-RAPL; J/op; EDP       & Pre-silicon DVFS research \\ \hline
\mmB & CosmoFlow-Power              & \citep{cosmoflow2019}        & J/epoch; GFLOPS/W                   & CNN scaling on 15 k+ GPUs \\ \hline
\mmB & HACC Energy Add-on           & \citep{hacc2020power}        & J/particle update                      & N-body cosmology power studies \\ \hline
\mmB & DeepCAM-Energy               & \citep{deepcam2020power}     & J/epoch (UNet)                         & Climate-analytics accelerator studies \\ \hline
\mmB & OpenIFS-Energy               & \citep{openifsenergy2023}    & kWh/model-day; W timeline             & Weather-model node comparison \\ \hline
\mmB & GROMACS-EE                   & \citep{gromacsee2024}        & J/ns; W/GPU                         & MD clock-vs-accuracy trade-offs \\ \hline
\mmB & NAMD-Power                   & \citep{namdpower2019}        & Energy-Delay-Product (ApoA1)             & Summit node DVFS optimisation \\ \hline
\mmB & QE Energy Suite              & \citep{qeenergy2022}         & J/SCF step; GFLOPS/W                & DFT GPU-offload studies \\ \hline
\mmB & VASP-Power Harness           & \citep{vasppower2023}        & W; kWh/MD step                        & Materials-science accelerator compare \\ \hline
\mmB & OpenFOAM-Energy              & \citep{openfoamenergy2021}   & J/1k iterations                       & CFD partitioning \& mesh tuning \\ \hline
\mmB & InSAR-AI Power Kit           & \citep{insarpower2024}       & J/satellite scene                      & Edge-to-cloud EO inference cost \\ \hline
\mmB & H3D-Energy                   & \citep{h3denergy2023}        & J/hydrology timestep                & Hydrology model DVFS exploration \\ \hline \hline\hline  
\rowcolor{gray!20} \multicolumn{5}{|l|}{Tool}\\ \hline
\mmT & PTDaemon/SERT Energy       & \citep{specptdaemonser}      & calibrated W; kWh (node)                & Lab reproducibility; Lot 9 labels \\ \hline
\mmT & Scaphandre                   & \citep{scaphandre}           & W; kWh (process/node, Prometheus)     & Slurm dashboards; power-cap feedback \\ \hline
\mmT & Kepler                       & \citep{kepler}               & W/pod; J/pod (eBPF)                 & Energy observability in K8s clusters \\ \hline
\mmT & CodeCarbon                   & \citep{codecarbon}           & kWh; kg CO\(_2\)e (process)             & Rapid CO\(_2\) estimation in pipelines \\ \hline
\mmT & CarbonTracker                & \citep{carbontracker}        & measured + predicted kWh; CO\(_2\)e     & Scheduling DL jobs in low-carbon hours \\ \hline
\mmT & PowerPACK/Mont-Blanc       & \citep{powerpackmontbl}      & W; J for MPI/OpenMP mini-apps         & Network-topology \& DVFS studies \\ \hline
\mmT & Cray PAT Energy Counters     & \citep{craypatenergyco}      & J/function; avg W                     & Kernel hotspot hunting on Shasta \\ \hline
\mmT & IBM PowerAPI (pmlib)         & \citep{ibmpowerapipmli}      & kWh (job/process)                      & Energy-aware scheduling on Summit \\ \hline
\mmT & NVIDIA DCGM Energy           & \citep{nvidiadcgmenerg}      & W; J (GPU) \@ 1Hz; telemetry           & GPU power-cap discovery; Green500 \\ \hline
\mmT & Intel VTune Power            & \citep{intelvtunepower}      & package W; J/function                 & Roofline-vs-energy tuning on Xeon \\ \hline 
\mmT & Cloudmesh GPU & \citep{cloudmesh-gpu} & Power Draw; Temperature & Temperature and energy frequency traces \\ \hline
  \end{tabular}
  }
\end{table*}
