...
\usepackage{hyperref}
\usepackage{etoolbox}
\usepackage{lineno,microtype,subcaption}
\usepackage[onehalfspacing]{setspace}

\makeatletter
\AtBeginDocument{%
    \def\URL@prefix{URL: }%
    \pretocmd{\thebibliography}{\raggedright}{}{} % Helps with URL line breaks
}
\makeatother
...
% Many Frontiers journals use
                                % the numbered referencing system, to
                                % find the style and resources for the
                                % journal you are submitting to:
                                % https://zendesk.frontiersin.org/hc/en-us/articles/360017860337-Frontiers-Reference-Styles-by-Journal

                                %
                                %
% temporarily ieeetran so we can do url=
